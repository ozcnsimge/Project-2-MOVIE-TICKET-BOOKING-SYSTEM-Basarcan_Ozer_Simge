...
public class SignUpPage extends JPanel {
	...
	public SignUpPage(double width, double height) {
		...
		this.signUpButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (userNameInput.getText().toString().length() == 0
						|| passwordInput.getPassword().toString().length() == 0
						|| passwordConfirmationInput.getPassword().toString().length() == 0) {
		...
		this.addComponentsToSignUpPage(width, height);

	}

	public boolean addComponentsToSignUpPage(double width, double height) {
